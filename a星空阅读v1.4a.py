...
class WXYD:
    ...
    def setstatus(self):
        try:
            ...
            p = {'key': self.key, 'type': 'xingkong', 'val': '1'}
    ...
    def info(self):
        ...
        p = {"code": "5G72U6YG6", "un": self.un, "token": self.token, "pageSize": 20}
    ...
    def testCheck(self, a, url):
        if checkDict.get(a[4]) != None:
            ...
            for i in range(60):
                if i % 30 == 0:
                    JhWxPusher.push(self.cg['name'], url, a[3], 'xingkong', self.cg['uids'], self.key)
    ...
    def submit(self):
        ...
        if rj.get('code') == 0:
            ...
            print(self.name, '提交任务异常异常，积分正常到账，不停止任务')
